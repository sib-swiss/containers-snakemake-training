...
??? success "Answer"
    ...
    To find how many genes are differentially expressed, check out the last output file, `results/deg_list.tsv`. 8 genes are differentially expressed in total: 3 up-regulated and 5 down-regulated.

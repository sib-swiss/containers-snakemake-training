...
### Optional: benchmarking a workflow
...
To make things even better, have a look at some [additional concepts and exercises](7_debugging_snakemake.md#using-non-conventional-outputs) and [Snakemake's best practices](https://snakemake.readthedocs.io/en/v9.11.6/snakefiles/best_practices.html)!
